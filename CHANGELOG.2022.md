...
- Добавьте новый домен в список разрешенных 'img-src': `'self' {адрес-ресурса}.ru
data: 'self'`
...
CHANGELOG за 2021 год доступен [здесь](https://github.com/core-ds/core-components/blob/master/CHANGELOG.2021.md)
