...
```jsx
// Десктоп/мобайл
import { PassCodeDesktop } from '@balafla/core-components/pass-code/desktop';
import { PassCodeMobile } from '@balafla/core-components/pass-code/mobile';

// Респонсив
import { PassCode } from '@balafla/core-components/pass-code';

// Если добавляете аддон, то можно обернуть его в KeyPadButton. Так не понадобится подгонять стили под другие кнопки.
import { KeyPadButton } from '@balafla/core-components/pass-code';
```
