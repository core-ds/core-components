...
render(() => {
    ...
    const onChange = (_, payload) => {
        ...
        if (!value.isSkeleton) {
            setValue(prevValue => ({ ...prevValue, skeletonAnimate: false }));
        };
    };
        ...
        <Container>
            <Row>
                <Col>
                    <Component
                        ...
                        skeletonAnimate={value.skeletonAnimate}
                    >
            ...
            <Row>
                <CheckboxGroup label='Контент' onChange={onChange}>
                    ...
                    { value.isSkeleton && <Checkbox label='Анимация скелетона' name='skeletonAnimate' checked={value.skeletonAnimate} size='m' /> }
                </CheckboxGroup>
            </Row>
