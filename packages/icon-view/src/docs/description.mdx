        ...
        <Container>
            <div style={styles}>
                {SIZES.map((size) => {
                    ...
                    return (
                        <Component key={size} size={size} mainSize={mainSize[size]} border={true}>
                            {size === '128' || size === '80' ? (
                                <DiamondsXxlIcon />
                            ) : size <= '20' ? (
                                <DiamondsSIcon />
            ...
            <Row>
                <CheckboxGroup label='Контент' onChange={onChange}>
                    <Checkbox
                        ...
                        size={24}
                    />
                    <Checkbox label='Изображение' name='image' checked={value.image} size={24} />
                    <Checkbox label='Текст' name='text' checked={value.text} size={24} />
                    <Checkbox label='Иконка' name='icon' checked={value.icon} size={24} />
                </CheckboxGroup>
            </Row>
        ...
        <Container>
            ...
            <Row>
                <RadioGroup
                    ...
                    value={content}
                >
                    <Radio label='Иконка' value='icon' size={24} />
                    <Radio label='Craftwork Emoji' value='emoji' size={24} />
                    <Radio label='Без контента' value='noContent' size={24} />
                </RadioGroup>
            </Row>
            ...
            <Row>
                <RadioGroup
                    ...
                    value={topAddons}
                >
                    <Radio label='Маленький индикатор' value='indicatorSmall' size={24} />
                    <Radio label='Индикатор' value='indicator' size={24} />
                    <Radio label='IconView' value='iconView' size={24} />
                    <Radio label='Без контента' value='noContent' size={24} />
                </RadioGroup>
            </Row>
