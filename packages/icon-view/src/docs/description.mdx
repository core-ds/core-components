    ...
    return (
        <Container>
            <Row>
                {SIZES.map(size => (
                    <Col key={size}>
                        <Component size={size}  style={{ marginRight: '20px'}}>
                            <SfTouchIdXxlIcon/>
                        </Component>
                    </Col>
                ))}
...
const iconViewSvg = <Circle size='20'> <DiamondsMIcon /> </Circle>
const iconViewImage = <Circle size='20' imageUrl="./images/alfa.png"/>
...
render(
    <Container>
        <Row>
            <Col>
                <SuperEllipse size='80' indicator={<Badge view='count' height={20} />} />
            </Col>

            <Col>
                <SuperEllipse size='80' topAddons={<Badge view='count' height={20} content={1}/>} />
            </Col>

            <Col>
                <SuperEllipse size='80' topAddons={<Badge view='count' height={20} content={25} />} />
            </Col>

            <Col>
                <SuperEllipse size='80' topAddons={<Badge view='count' height={20} content={100} />}
                />
            </Col>
        </Row>
    </Container>
