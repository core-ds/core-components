...
Для шейпа SuperEllipse есть возможность включить скелетонизацию и анимацию скелетонизации.
...
render(() => {
    ...
    const onChangeRadio = (_, payload) => {
        ...
        if (payload.value !== "SuperEllipse") {
            setValue((prevValue) => ({ ...prevValue, isSkeleton: false, skeletonAnimate: false }));
        }
    };
            ...
            <Row>
                <CheckboxGroup label='Контент' onChange={onChange}>
                    ...
                    {component === 'SuperEllipse' &&
                        <Checkbox label='Скелетонизация' name='isSkeleton' checked={value.isSkeleton} size='m' />
                    }
                    {component === 'SuperEllipse' && value.isSkeleton &&
                        <Checkbox label='Анимация скелетона' name='skeletonAnimate' checked={value.skeletonAnimate} size='m' />
                    }
                </CheckboxGroup>
            </Row>
