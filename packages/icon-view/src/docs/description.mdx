            ...
            <Row>
                ...
                >
                    {['SuperEllipse', 'Circle', 'Rectangle', 'NoShape'].map(c => (
                        <Radio label={c === 'NoShape'? 'noShape' : c.toLowerCase()} value={c} size='m' key={c} />
                    ))}
                </RadioGroup>
            </Row>
        </Container>
        ...
        <Container>
            <Row>
                <Col>
                    <Component
                        size='80'
                        backgroundColor={value.background ? 'var(--color-light-bg-secondary)' : 'transparent'}                        
                        imageUrl={value.image && "./images/imgBg.png"}
                        text={value.text &&
                          <Typography.Title 
                            view='small' weight='bold' 
                            font='system' color='secondary'>
                              БК
                          </Typography.Title>
                        }
                        backgroundIcon={value.icon && DiamondsMIcon}
                    />
                </Col>
            </Row>
            ...
            <CheckboxGroup
                ...
                onChange={onChange}
            >
                <Checkbox label='Цвет фона' name='background' checked={value.background} size='m' />
...
В зависимости от размера, компонент поддерживате один или несколько слотов. 
...
render(() => {
    ...
    const iconViewSvg = bottomAddons === 'iconView' && <Circle size='24' backgroundIcon={ThumbUpCompactMIcon} />
...
Компонент [Indicator](?path=/docs/components-indicator--docs) может отображаться только в верхнем аддоне. 
