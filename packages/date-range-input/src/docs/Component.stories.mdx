...
import styles from '!!raw-loader!../components/base-date-range-input/index.module.css';
...
import { DateRangeInputResponsive } from '@alfalab/core-components/date-range-input/responsive';
```
