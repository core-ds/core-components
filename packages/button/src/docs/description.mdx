...
<Container>
    <Row align='middle'>
        ...
        <Col>
            <ButtonDesktop view='primary'>Primary</ButtonDesktop>
        </Col>
        <Col>
            <ButtonDesktop view='secondary'>Secondary</ButtonDesktop>
        </Col>
        <Col>
            <ButtonDesktop view='tertiary'>Tertiary</ButtonDesktop>
        </Col>
        <Col>
            <ButtonDesktop view='link'>Link</ButtonDesktop>
        </Col>
        <Col>
            <ButtonDesktop view='ghost'>Ghost</ButtonDesktop>
        </Col>
    </Row>
</Container>
//MOBILE
