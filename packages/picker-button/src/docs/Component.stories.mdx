...
import Changelog from '../../CHANGELOG.md'; import {PickerButtonMobile} from "../Component.mobile"; import {
...
<Story name='PickerButtonMobile'>
    <PickerButtonMobile options={[]} />
</Story>

<Story name='PickerButtonResponsive'>
    <PickerButtonResponsive options={[]} />
</Story>
