    ...
    {React.createElement(() => {
        ...
        return (
            ...
            >
                ...
                <Tab title='Очень длинное название таба' id='tab-5' disabled>
                    Таб 5
                </Tab>
                <Tab title='Таб 6' id='tab-6'>
                    Таб 5
                </Tab>
                <Tab title='Таб 7' id='tab-7'>
                    Таб 5
                </Tab>
                <Tab title='Таб 8' id='tab-8'>
                    Таб 5
                </Tab>
                <Tab title='Таб 10' id='tab-10'>
                    Таб 5
                </Tab>
                <Tab title='Таб 11' id='tab-11'>
                    Таб 5
                </Tab>
                <Tab title='Таб 12' id='tab-12'>
                    Таб 5
                </Tab>
                <Tab title='Таб 13' id='tab-13'>
                    Таб 5
                </Tab>
                <Tab title='Таб 14' id='tab-14'>
                    Таб 5
                </Tab>
            </TabsComponent>
        );
