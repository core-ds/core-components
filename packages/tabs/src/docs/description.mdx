...
С помощью слотов `RightAddons`, `LeftAddons`, `BottomAddons` можно кастомизировать таб. Например, добавить иконку.
...
render(() => {
    ...
    const addon = (<div style={addonStyle}/>);
    const bottomAddon = (<div style={{...addonStyle, width: '100%'}}/>);
    ...
    return (
        <>
            <TabsDesktop size='xs' selectedId={selectedId} onChange={handleChange}>
                ...
                <Tab title='Californium' id='tab-5' leftAddons={addon} />
            </TabsDesktop>
            <div style={{ marginTop: 20 }}>
                ...
                >
                    ...
                    <Tab title='Neptunium' id='tab-4' rightAddons={addon} />
                    <Tab title='Californium' id='tab-5' leftAddons={addon} />
                    <Tab title='Einsteinium' id='tab-6' bottomAddons={bottomAddon} />
                </TabsDesktop>
            </div>
        </>
    );
...
render(() => {
    ...
    const addon = (<div style={addonStyle}/>);
    const bottomAddon = (<div style={{...addonStyle, width: '100%', height: '10px',}}/>);
