...
Чтобы смена происходила автоматически, используйте [Typography.TitleResponsive](/docs/typography--typography-title-responsive), для ручного управления — [Typography.Title](/docs/typography--typography-title). По умолчанию компоненты заголовков используют шрифт styrene. Для включения системных шрифтов используйте `font='system'`.
