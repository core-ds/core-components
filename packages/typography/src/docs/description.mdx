...
import { TitleResponsive, TitleDesktop, TitleMobile, Text } from '@alfalab/core-components/typography';
...
Чтобы смена происходила автоматически, используйте [TitleResponsive](/docs/typography--title-responsive), для ручного управления — [TitleDesktop](/docs/typography--title-desktop) и [TitleMobile](/docs/typography--title-mobile).
...
render(() => {
    ...
    return (
        <>
            ...
            <Text tag='p' view='primary-medium' showSkeleton={showSkeleton}>
