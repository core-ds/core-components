...
<Meta title='Компоненты/Прочие компоненты/Typography' component={Typography} />
...
<ComponentHeader
    ...
    design='https://www.figma.com/file/ZZ5kKTQF48ZjafL6utHmIG/Web-Hybrid-Typography?node-id=3511%3A1383'
/>
...
<Tabs
    ...
    changelog={<Changelog />}
    props={<ArgsTable components={TypographyTS} />}
/>
