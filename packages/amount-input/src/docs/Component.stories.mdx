...
import { AmountInput as AmountInputTS } from '../Component';
import { version } from '../../package.json';
import Changelog from '../../CHANGELOG.md';
import Description from './description.mdx';
import styles from '!!raw-loader!../index.module.css';

<Meta title='Components/Forms/Inputs/AmountInput' component={AmountInput} id='AmountInput' />
...
<Tabs
    ...
    changelog={<Changelog />}
    props={<ArgsTable of={AmountInputTS} />}
