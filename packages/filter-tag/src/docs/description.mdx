...
Компонент используется в комбинациях с [Select](/docs/components-selects-select--select), [Сalendar](/docs/components-forms-calendars-calendar--calendar),
                ...
                {SIZES.map((size) => (
                    <Col key={size}>
                        <FilterTag
                            ...
                            onClear={() =>
                                setCheckedFilterTag(
                                    checkedFilterTag.filter((item) => item !== size),
                                )
                            }
                ...
                {Object.entries(content).map(([key, value]) => (
                    <Col key={key}>
                        <FilterTag
                            ...
                            onClear={() =>
                                setCheckedFilterTag(checkedFilterTag.filter((item) => item !== key))
                            }
