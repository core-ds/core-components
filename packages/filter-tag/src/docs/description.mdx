...
render(() => {
    ...
    // Диапазон значений
    const filterTagRef = React.useRef(null);
    ...
    handleBlur(calendarRef, (event) => {
        if (filterTag.current && !filterTag.current.contains(event.target)) {
            handleOpen();
        }
    });
        ...
        <Container>
            <Row align='middle'>
                <div style={{ marginRight: 12 }}>
                    <FilterTag size={32} checked={false}>
                        {content}
                    </FilterTag>
                </div>
                <div>
                    <FilterTag size={32} checked={false} disabled={true}>
                        {content}
                    </FilterTag>
                </div>
            </Row>
            <div style={{ display: 'flex', marginTop: 12 }}>
                <div style={{ marginRight: 12 }}>
                    <FilterTag size={32} checked={true}>
                        {checkedContent}
                    </FilterTag>
                </div>
                <div>
                    <FilterTag size={32} checked={true} disabled={true}>
                        {checkedContent}
                    </FilterTag>
                </div>
            </div>
