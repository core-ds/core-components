...
const widthOptions = [
    ...
    { key: '600', content: '600', value: 600 },
    { key: '800', content: '800', value: 800 },
    { key: 'fullWidth', content: 'Full', value: 'fullWidth' },
];
    ...
    return (
        <React.Fragment>
            ...
            <Typography.Text tag='p'>
                ...
                бизнес-процессы и доказать банку законность операций. Специалисты собрали понятные
                рекомендации, как сэкономить время на объяснения и предотвратить блокировки
            </Typography.Text>
        </React.Fragment>
    );
};
...
render(() => {
    ...
    const [selectedWidth, setSelectedWidth] = React.useState('500');
            ...
            <Space size={12}>
                ...
                <div style={{ width: 360 }}>
                    <SelectDesktop
                        ...
                        block={true}
                        onChange={({ selected }) => {
                            setModalWidth(selected.value);
                            setSelectedWidth(selected.key);
                        }}
                    />
                </div>
                <div style={{ width: 360 }}>
            ...
            >
                ...
                <UniversalModalDesktop.Content>
                    ...
                    <Typography.Text tag='p'>
                        ...
                        понятные рекомендации, как сэкономить время на объяснения и предотвратить
                        блокировки
                    </Typography.Text>
