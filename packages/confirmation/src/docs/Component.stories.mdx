...
<Story name='Confirmation'>
    {React.createElement(() => {
        const component = select('ConfirmationComponent', ['ConfirmationResponsive', 'Confirmation', 'ConfirmationMobile'], 'ConfirmationResponsive');
        const variants = [
...
<Tabs
    ...
    changelog={<Changelog />}
    props={<ArgsTable components={{Confirmation: ConfirmationDesktopTS, ConfirmationMobile: ConfirmationMobileTS, ConfirmationResponsive: ConfirmationResponsiveTS}} />}
