...
<Story name='Underlay'>
    {React.createElement(() => {
        ...
        const borderRadius = {
            bottomRight: select('borderRadius.bottomRight', paddingSizes, 'm', 'underlayProps'),
            bottomLeft: select('borderRadius.bottomLeft', paddingSizes, 'm', 'underlayProps'),
            topRight: select('borderRadius.topRight', paddingSizes, 'm', 'underlayProps'),
            topLeft: select('borderRadius.topLeft', paddingSizes, 'm', 'underlayProps'),
        }
