        ...
        <div style={{ width: 344 }}>
            ...
            <div style={{ marginBottom: 32 }}>
                ...
                >
                    ...
                    <Radio size='m' label='Может принимать и диапазон и дату' value='singleAndRange' />
                </RadioGroup>
            </div>
            <div>
                <RadioGroup
...
render(() => {
    ...
    const css = `
       div[data-test-id='test1'][data-test-id='test1']> div {
            width: 100%;
        }

        div[data-test-id='test1'][data-test-id='test1']> div> div {
            padding-left: 0;
            padding-right: 0;
        }
    `;
    ...
    return (
        <>
            <div data-test-id='test1' style={{width: '344px', ...calendarStyles}}>
            <style>{css}</style>
