...
import { Calendar, PeriodSlider, usePeriod, usePeriodWithReset } from '@alfalab/core-components-calendar';
...
<Meta title='Компоненты/Календари/Calendar' component={Calendar} />
...
<Tabs
    ...
    changelog={<Changelog />}
    props={<ArgsTable components={{ Calendar: CalendarDesktopTS, CalendarMobile: CalendarMobileTS, CalendarResponsive: CalendarResponsiveTS, PeriodSlider: PeriodSliderTS }} />}
