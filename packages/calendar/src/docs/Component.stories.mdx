...
import { Calendar, usePeriod } from '@alfalab/core-components-calendar';
...
<Story name='Calendar'>
    {React.createElement(() => {
        ...
        // TODO: удалить после дизайн чека
        const onPeriodClick = text('cb on period click', '');
        const renderContent = () => {
            if (device === 'desktop') {
                return (
                    <div
                    ...
                    >
                        <div style={WRAPPER_STYLES}>
                            <style>{`:root{--calendar-width: 312px;}`}</style>
                            <ModeChecker />
                            <Calendar
                                defaultMonth={
