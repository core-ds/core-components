...
<Meta title='Components/Progress/Skeleton' component={Skeleton} id='Skeleton' />
...
<ComponentHeader name='Skeleton' version={version} package='@alfalab/core-components/skeleton' />
