...
<Story name='GenericWrapper'>
    {() => {
        const gapSizes = [0, 2, 4, 8, 12, 16, 20, 24];
        ...
        const gapSize1 = select('1st Gap size', gapSizes, 20);
        const gapSize2 = select('2nd Gap size', gapSizes, 20);
        ...
        return (
            ...
            >
                ...
                <Gap size={20} direction='horizontal' />
            </div>
        );
    }}
</Story>
