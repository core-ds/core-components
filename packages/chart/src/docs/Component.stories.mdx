...
<Meta title='Компоненты/Таблицы и графики/Chart' />
...
<ComponentHeader name='Chart' version={version} package='@alfalab/core-components/chart' />

```jsx
import { Chart } from '@alfalab/core-components/chart';
```

<Tabs description={<Description />} changelog={<Changelog />} props={<ArgsTable of={ChartTS} />} />
