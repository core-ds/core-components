...
describe('ActionButton', () => {
    ...
    describe('Custom component', () => {
        it('should pass `to` instead `href` to custom component by default', () => {
            const cb = jest.fn();
            cb.mockReturnValue(null);

            render(<ActionButton Component={forwardRef(cb)} href='test' />);
        ...
        it('should use custom hrefProp for custom component', () => {
            ...
            render(<ActionButton Component={forwardRef(cb)} href='test' hrefProp='customHref' />);
        ...
        it('should use hrefProp="href" for Next.js Link component', () => {
            ...
            render(<ActionButton Component={forwardRef(cb)} href='/test' hrefProp='href' />);
        ...
        it('should use custom hrefProp for native elements', () => {
            const { container } = render(<ActionButton href='test' hrefProp='customHref' />);
