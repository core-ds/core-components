        ...
        return (
            ...
            >
                <Indicator
                    ...
                    color={text('color', 'var(--color-light-text-primary-inverted)')}
                    backgroundColor={text('backgroundColor', 'var(--color-light-bg-accent)')}
                    border={boolean('border', true) && {
                        color: text('border.color', 'var(--color-light-border-primary-inverted)'),
