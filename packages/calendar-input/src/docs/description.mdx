...
Настройки календаря можно посмотреть на страничке компонента [Calendar](?path=/docs/calendar--docs).
...
[Calendar](?path=/docs/calendar--docs) переданный в [Popover](?path=/docs/popover--docs).
