...
<Meta title='Компоненты/Прочие компоненты/Collapse' component={Collapse} />
...
<ComponentHeader name='Collapse' version={version} package='@alfalab/core-components-collapse' />
