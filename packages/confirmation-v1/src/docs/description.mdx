...
Компонент Confirmation версии 9.0.7 - больше не поддерживается, переходите на актуальную версию [Confirmation](/docs/компоненты-составные-компоненты-confirmation--confirmation)

[Инструкция по обновлению](/docs/инструкции-обновление-confirmation--page)
