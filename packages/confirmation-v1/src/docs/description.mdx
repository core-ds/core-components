...
Компонент Confirmation версии 9.0.7 - больше не поддерживается, переходите на актуальную версию [Confirmation](/docs/confirmation--confirmation)

[Инструкция по обновлению](/docs/instructions-confirmation-update--page)
