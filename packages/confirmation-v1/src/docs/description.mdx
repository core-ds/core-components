...
Компонент Confirmation версии 9.0.7 - больше не поддерживается, переходите на актуальную версию [Confirmation](?path=/docs/components-confirmation--docs)

[Инструкция по обновлению](?path=/docs/for-users-обновление-confirmation--docs)
