...
Компонент Confirmation версии 9.0.7 - больше не поддерживается, переходите на актуальную версию [Confirmation](/docs/components-authentication-confirmation--confirmation)
