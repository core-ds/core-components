type IndicatorTagSize = 32 | 40 | 48 | 56;
...
const ROUNDED_CIRCLE_56 =
    'M28 0C43.464 0 56 12.536 56 28C56 43.464 43.464 56 28 56C12.536 56 0 43.464 0 28C0 12.536 12.536 0 28 0Z';
...
const RECTANGULAR_NONE_56 =
    'M12 0H44C50.6274 0 56 5.3726 56 12V44C56 50.6274 50.6274 56 44 56H12C5.3726 56 0 50.6274 0 44V12C0 5.3726 5.3726 0 12 0Z';
...
export const indicatorTagGeometry = {
    rounded: {
        dot: {
            ...
            // 56: { width: 56, height: 56, indicatorX: 53, indicatorY: 3 },
        },
        count: {
            ...
            // 56: { width: 56, height: 56, indicatorX: 51.5, indicatorY: 4 },
        },
    },
    rectangular: {
        dot: {
