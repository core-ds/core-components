...
Служат триггерами для переключения контекста, см. компонент [Tabs](/docs/components-forms-selects-tabs--tabs).  
Используются для фильтрации контента, см. компонент [FilterTag](/docs/components-forms-selects-filtertag--filter-tag).  
Выполняют роль радио-кнопок см. компонент [RadioGroup](/docs/components-forms-selects-radiogroup--radio-group).  
Выполняют роль чекбоксов см. компонент [CheckboxGroup](/docs/components-forms-selects-checkboxgroup--checkbox-group).  