                ...
                {VIEWS.map((item) => (
                    <div key={item.key} style={{ marginRight: 12 }}>
                        <Tag
                            ...
                            onClick={() => setChecked({ ...checked, [item.key]: !checked[item.key] })}
                        >
                            Label
                        </Tag>
                    </div>
                ...
                {ROUNDEDS.map((item) => (
                    <div key={item.key} style={{ marginRight: 12 }}>
                        <Tag
                            ...
                            onClick={() => setCheckedRounded({ ...checkedRounded, [item.key]: !checkedRounded[item.key] })}
                        >
                            Label
                        </Tag>
                    </div>
                ...
                {RECTANGLES.map((item) => (
                    <div key={item.key} style={{ marginRight: 12 }}>
                        <Tag
                            ...
                            onClick={() => setCheckedRectangular({ ...checkedRectangular, [item.key]: !checkedRectangular[item.key] })}
                        >
                            Label
                        </Tag>
                    </div>
