            ...
            <Space direction='horizontal' align='start' size={[20]}>
                {BIG_SIZES.map((size) => (
                    <ProductCover.Single
                        ...
                        baseUrl={CORE_COMPONENTS_CARD_IMAGE_BASE_URL}
