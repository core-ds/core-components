...
render(() => {
    ...
    const [navigationState, setNavigation] = React.useState('always');
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            >
                <Radio size={24} label='Доступны всегда' value='always' />
                <Radio size={24} label='Доступны по ховеру' value='hover' />
                <Radio size={24} label='Без кнопок' value='never' />
            </RadioGroup>
            <Gap size={24} />
            <RadioGroup
                label='Поведение'
        ...
        >
            ...
            >
                <Carousel
                    ...
                    visibleItems={'auto'}
                    gap={8}
                    navigation={isMobile() ? 'never' : 'always'}
                    overflow={overflow}
                />
            </div>
            <Gap size={8} />
