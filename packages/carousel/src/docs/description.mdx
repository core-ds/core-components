...
```jsx live
const CarouselItem = ({ bgColor, itemColor }) => {
    return (
        <div
            style={{
                background: bgColor,
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column' }}>
            <Carousel
                ...
                navigation={navigationState === 'hover' ? navigationState : navigationState}
                gap={8}
                loop={loop}
...
render(() => {
    ...
    return (
        ...
        >
            <div
                style={{
                    padding: isMobile() ? 20 : '20px 80px',
                    background: isMobile() ? undefined : 'var(--color-light-base-bg-secondary)',
                    borderRadius: isMobile() ? undefined : 'var(--border-radius-20)',
                }}
            >
                <Carousel
                    items={[
