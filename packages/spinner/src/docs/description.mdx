        ...
        <Row align='middle'>
            {PRESETS.map((preset) => (
                <div key={preset} style={{ marginRight: 20 }}>
                    <SpinnerPreset visible={true} preset={preset} />
                </div>
            ))}
        </Row>
    </Container>,
...
```jsx live
    <Container>
        ...
        <div>
            <Button leftAddons={<SpinnerPreset visible={true} />} size={56}>
                Дела делаются
            </Button>
        </div>
    </Container>
//MOBILE
    <Container>
        ...
        <br/>
        <Button block={true} leftAddons={<SpinnerPreset visible={true} />} size={56}>
            Дела делаются
        </Button>
    </Container>
```
