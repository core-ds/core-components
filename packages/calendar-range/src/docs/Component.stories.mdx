...
<Meta title=' Components/Forms/Calendars/CalendarRange' component={CalendarRange} />

<!-- Canvas -->

<Story name='CalendarRange'>
    <CalendarRange calendarPosition={select('calendarPosition', ['static', 'popover'], 'static')} />
</Story>
