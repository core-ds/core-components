...
<Meta title='Компоненты/Прочие компоненты/BankCard' component={BankCard} />
...
<ComponentHeader name='BankCard' version={version} package='@alfalab/core-components/bank-card' />
