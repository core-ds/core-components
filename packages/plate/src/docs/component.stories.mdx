...
<Story name='Plate'>
    {React.createElement(() => {
        const view = select('view', ['common', 'negative', 'positive', 'attention', 'custom'], 'positive');
        return (
            <Plate
                view={view}
                ...
                buttons={boolean('buttons', false) ? [
                    <Button view='primary'>Хорошо</Button>,
                    <Button>Подробнее</Button>,
                ] : null}
                subAddons={boolean('subAddons', false) ? [
                    <Button view='link' size='xxs'>Хорошо</Button>,
                    <Button view='secondary' size='xxs'>Подробнее</Button>,
                ] : null}
            >
