...
<Container>
    <Typography.Title font='system' view='medium' weight='regular'>
        <AmountComponent value={123400} minority={100} currency='RUB' bold='none' />
    </Typography.Title>
    <Gap size={20} />
    <Typography.Title font='system' view='medium' weight='regular'>
        <AmountComponent
...
render(() => {
    ...
    console.log('textStyle', isHeadline, textStyle);
    ...
    return (
        <Container>
            ...
            >
                ...
                <Radio size={24} label='Только для мажорной части' value='major' />
                <Radio size={24} label='Для всей суммы' value='full' />
            </RadioGroup>
            <Gap size={24} />
            <RadioGroup
