...
interface OptionsListRef extends ComponentRef<typeof List> {
...
function OptionsListRenderFunction<OptionType>(
    ...
    useEffect(() => {
        const listScrollableElement = noOptions ? null : listRef.current?.getScrollableElement();
    ...
    useImperativeHandle(
        ...
        () => ({
            ...
            getScrollableElement() {
                return listRef.current?.getScrollableElement() ?? null;
            },
            scrollToIndex(index, scrollOptions) {
                listRef.current?.scrollToIndex?.(index, scrollOptions);
            },
        }),
        [],
    );
    ...
    return (
        <div
            {...innerProps}
            ref={mergeRefs([rootElementRef, elementRef, innerProps?.ref ?? null])}
