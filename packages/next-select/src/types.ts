...
import { ListProps, ListRefType, RenderItemExtraProps } from './components/list';
...
export interface OptionListProps<OptionType>
    extends Pick<ListProps<OptionType>, 'width' | 'minWidth' | 'nativeScrollbar' | 'onScroll'> {
    listRef?: React.Ref<ListRefType>;
