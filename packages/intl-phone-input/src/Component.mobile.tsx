...
import { BaseSelectChangePayload, SelectProps } from '@alfalab/core-components-select';
...
import { CountriesSelectMobile, FlagIcon } from './components';
...
export type IntlPhoneInputMobileProps = Partial<Omit<InputAutocompleteMobileProps, 'onChange'>> &
...
export const IntlPhoneInputMobile = forwardRef<HTMLInputElement, IntlPhoneInputMobileProps>(
    (
        ...
        const handleChange = (payload: string | BaseSelectChangePayload) => {
            if (typeof payload === 'string') {
                setCountryByDialCodeWithLengthCheck(payload);
                changePhone(payload);
        ...
        return (
            <InputAutocompleteMobile
                ...
                bottomSheetProps={{
                    hasCloser: false,
                    ...(!showActionButtons && { actionButton: undefined }),
                }}
                bottomSheetHeaderAddonsProps={{
                    ref: inputRef,
                    leftAddons: renderCountriesSelect(),
