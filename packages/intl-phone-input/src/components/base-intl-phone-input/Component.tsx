...
import {
    InputAutocomplete as DefaultInputAutocomplete,
    ...
    (
        {
            ...
            InputAutocomplete = DefaultInputAutocomplete,
        ...
        const getInputAutocompleteProps = (): Partial<InputAutocompleteProps> => ({
            readOnly,
            inputProps: {
                ...inputProps,
                clear: clear && !isEmptyValue,
        ...
        return (
            <InputAutocomplete
                ...
                {...(view === 'desktop'
                    ...
                    : getInputAutocompleteMobileProps())}
