...
<ComponentHeader
    name='SystemMessage'
    design='https://www.figma.com/file/cdNnkh2QdxuvYLrBm4cubM/Web-%3A%3A-Core-Default-Components?type=design&node-id=97264%3A163212&mode=design&t=Itgzojk9BOtPqYkS-1'
