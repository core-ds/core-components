...
import { Checkmark } from "@alfalab/core-components-select/components/checkmark";
...
<Meta title='Компоненты/Селекты/Select' component={Select} />
...
```jsx
import { Select } from '@alfalab/core-components/select;
import { SelectResponsive } from '@alfalab/core-components-select/select/responsive';
import { SelectMobile } from '@alfalab/core-components/select/select-mobile';
```

<Tabs
    description={<Description />}
    props={<ArgsTable of={SelectTS} />}
