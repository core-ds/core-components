...
По умолчанию селект вызывает [Popover](/docs/компоненты-модалки-и-поповеры-popover--popover) с вариантами выбора.
На мобильных устройствах варианты выбора отображаются в [BottomSheet](/docs/компоненты-модалки-и-поповеры-bottomsheet--bottom-sheet).
