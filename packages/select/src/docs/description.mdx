...
const OPTIONS = [{ key: '1', content: 'Neptunium Neptunium Neptunium Neptunium' }];
    ...
    React.useEffect(() => {
        setTimeout(() => {
            setOptions([
                {
                    key: '1',
                    content: 'Neptunium Neptunium Neptunium Neptunium Neptunium Neptunium',
                },
            ]);
        }, 3000);
    }, []);
    ...
    return (
        <div style={{ width: 320 }}>
            <SelectDesktop
                ...
                OptionsList={NextVirtualOptionsList}
            />
        </div>
    );
});
    ...
    const loadingProps = useSelectWithLoading({
        ...
        Option: (props) => (
            <BaseOption
                ...
                option={{
                    ...props.option,
                    content: <div style={{ padding: 'var(--gap-12)' }}>{props.option.content}</div>,
                }}
            />
        ),
    });
        ...
        Option: (props) => (
            <BaseOption
                ...
                option={{
                    ...props.option,
                    content: (
                        <div style={{ padding: 'var(--gap-16) var(--gap-12)' }}>
