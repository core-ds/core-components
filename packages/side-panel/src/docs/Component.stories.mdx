...
import { Content as ContentTS } from '../components/content/Component';
import { Footer as FooterTS } from '../components/footer/Component'
...
<Tabs
    ...
    props={<ArgsTable components={{SidePanelDesktop: SidePanelDesktopTS, SidePanelMobile: SidePanelMobileTS, SidePanelResponsive: SidePanelResponsiveTS, 'SidePanel.Header': HeaderTS, 'SidePanel.Content': ContentTS, 'SidePanel.Footer': FooterTS}} />}
/>
