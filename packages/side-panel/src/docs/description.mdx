...
render(() => {
    ...
    return (
        <Container>
            <Button type='button' size={48} onClick={handleOpen}>
                Показать анатомию
            </Button>
...
render(() => {
    ...
    return (
        <Container>
            <Button type='button' size={40} onClick={handleOpen}>
                Показать анатомию
            </Button>
                        ...
                        <SidePanelDesktop.Controls
                            primary={
                                footerSettings.hasPrimaryButton ? (
                                    <Button view='primary' size={48} onClick={handleClose}>
                                        Primary
                                    </Button>
                                ) : null
                            }
                            secondary={
                                footerSettings.hasSecondaryButton ? (
                                    <Button view='secondary' size={48} onClick={handleClose}>
                                        Secondary
                                    </Button>
                                ) : null
                            }
...
render(() => {
    ...
    return (
        <Container>
            <Button size={40} onClick={handleOpen}>
                Открыть сайд панель
            </Button>
