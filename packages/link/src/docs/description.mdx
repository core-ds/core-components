...
Подчеркивание ссылок не является обязательным, но помогает пользователю определить их тип.
В большинстве веб-продуктов используются ссылки с подчеркиванием.
