...
<Story name='SegmentedControl'>
    {React.createElement(() => {
        ...
        return (
            ...
            >
                <Segment id={1} title='Сегмент 1'>Сегмент 1</Segment>
                <Segment id={2} title='Сегмент 2'>Сегмент 2</Segment>
                <Segment id={3} title='Сегмент 3'>Сегмент 3</Segment>
                <Segment id={4} title='Сегмент 4'>Сегмент 4</Segment>
                <Segment id={5} title='Сегмент 4'>Сегмент 4</Segment>
                <Segment id={6} title='Сегмент 4'>Сегмент 4</Segment>
                <Segment id={7} title='Сегмент 4'>Сегмент 4</Segment>
                <Segment id={8} title='Сегмент 4'>Сегмент 4</Segment>
            </SegmentedControl>
        )
    })}
</Story>
