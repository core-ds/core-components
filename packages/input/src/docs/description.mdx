...
Основным типом инпутов в десктопном вебе являются инпуты размера 56 с внутренним расположением лейбла.
Для мобильного веба рекомендуемый размер 48 с внешним расположением лейбла.
