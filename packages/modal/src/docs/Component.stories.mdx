...
export const Content = ({ isPreview }) => {
    ...
    return isPreview ? (
        ...
        <>
            ...
            <Button className='showMoreButton' size={40} type='Button' onClick={() => setShowMore(!showMore)}>
...
<Story name='Modal'>
    {React.createElement(() => {
        ...
        const shouldRenderHeader = header && (Boolean(headerTitle) || Boolean(hasCloser) || Boolean(hasBackButton));
                    ...
                    {footer && (
                        <ModalComponent.Footer sticky={stickyFooter}>
                            <ModalComponent.Controls
                                ...
                                gap={footerGap}
                                primary={
                                    <FooterButton size={isMobile ? 56 : 48} view='primary'>
                                        {isPreview ? 'Кнопка' : 'Сохранить'}
                                    </FooterButton>
                                }
                                secondary={
                                    <FooterButton size={isMobile ? 56 : 48} view='secondary'>
