...
render(() => {
    ...
    return (
        <Container>
            ...
            <ModalMobile open={open} onClose={handleClose} size='m'>
                <Header />
...
const SIZES = [
    { value: 's', label: 'Small (500рх)' },
    { value: 'm', label: 'Medium (600рх)' },
    { value: 'l', label: 'Large (800рх)' },
    { value: 'xl', label: 'xLarge (1140рх)' },
...
render(() => {
    ...
    return (
        <Container>
            ...
            <ModalDesktop open={open} onClose={handleClose} size={size} key={getKey()}>
                {showHeader && (
                    <ModalDesktop.Header
            ...
            <ModalMobile open={open} onClose={handleClose} key={getKey()}>
                ...
                {showFooter && (
                    ...
                    >
                        ...
                        {footerSettings.hasSecondaryButton && (
                            <Button view='secondary' size='s' onClick={handleClose} block={true}>
                                Secondary
                            </Button>
                        )}
                    </ModalMobile.Footer>
...
render(() => {
    ...
    return (
        <Container>
            <Button size={document.body.clientWidth < 450 ? 'xs' : 's'} onClick={handleOpen}>
                Показать модалку
            </Button>

            <ModalResponsive open={open} onClose={handleClose} fixedPosition={true}>
                ...
                <ModalResponsive.Footer sticky={true}>
                    <Button
                        size={document.body.clientWidth < 450 ? 'xs' : 's'}
                        view='primary'
                        onClick={
