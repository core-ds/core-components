 ...
 *  Если этого не сделать, то плагин rollup-plugin-ts не будет понимать, что зависимости @alfalab/core-components-`*`/shared и др являются внешними и будет дублировать их в каждом пакете
 */
