...
<Plate limitContentWidth={false}>Для глобального переопределения breakpoint во всех Responsive компонентах [используйте CoreConfig](https://core-ds.github.io/core-components/master/?path=/docs/instructions-core-config--docs)</Plate>
