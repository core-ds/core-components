...
<Meta title='Инструкции/Брейкпоинты' parameters={{ previewTabs: { canvas: { hidden: true } } }} />
...
При особой необходимости, для рендеринга по условию в шаблонах используйте компонент [Mq](https://core-ds.github.io/core-components/master/?path=/docs/компоненты--mq), который основан на `window.matchMedia API`:
