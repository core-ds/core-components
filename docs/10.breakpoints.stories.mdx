...
<Meta title='Instructions/Брейкпоинты' parameters={{ previewTabs: { canvas: { hidden: true } } }} />
...
При особой необходимости, для рендеринга по условию в шаблонах используйте компонент [Mq](https://core-ds.github.io/core-components/master/?path=/docs/components--mq), который основан на `window.matchMedia API`:
