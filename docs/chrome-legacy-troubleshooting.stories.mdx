...
<Meta
    title='For users/Траблшутинг для старых версий Chrome'
    parameters={{ previewTabs: { canvas: { hidden: true } } }}
    id='Instructions/chrome_legacy_troubleshooting'
/>
...
**Большинство проблем решается поднятием библиотеки до последней актуальной версии**. Регулярно обновляйте Core Components для получения исправлений совместимости и улучшений производительности.
