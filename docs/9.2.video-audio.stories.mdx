...
<Meta
    title='Guidelines/Доступность/Аудио и видео'
    parameters={{ previewTabs: { canvas: { hidden: true } } }}
    id='Guidelines/Accessibility/Audio-video'
/>
...
<iframe
    ...
    src='//coub.com/embed/vdmae?muted=false&autostart=false&originalSize=false&startWithHD=false'
    frameBorder='0'
    width='640'
    height='360'
    allow='autoplay'
...
<br />
<br />
<p id='video-description'>Видео-реклама банковской карты World of Warships.</p>
