...
<Source
    ...
    src: url('https://${CDN_ENV}/media/fonts/alfa-interface-sans_regular.woff2') format('woff2');
    font-weight: 400;
    font-style: normal;
}
@font-face {
    font-family: 'Alfa Interface Sans';
    src: url('https://${CDN_ENV}/media/fonts/alfa-interface-sans_medium.woff2') format('woff2');
    font-weight: 500;
    font-style: normal;
}
@font-face {
    font-family: 'Alfa Interface Sans';
    src: url('https://${CDN_ENV}/media/fonts/alfa-interface-sans_bold.woff2') format('woff2');
    font-weight: 700;
    font-style: normal;
}`}
/>
