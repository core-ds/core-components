...
export const CDN_HOST = process.env.SERVICE_CDN_HOST_ENV;
...
<Source
    ...
    src: url('https://${CDN_HOST}/media/fonts/styrene-ui/styrene-ui_regular.woff2')
            format('woff2'), url('https://${CDN_HOST}/media/fonts/styrene-ui/styrene-ui_regular.woff')
            format('woff');
    font-weight: 400;
    font-style: normal;
}
@font-face {
    font-family: 'Styrene UI';
    src: url('https://${CDN_HOST}/media/fonts/styrene-ui/styrene-ui_medium.woff2') format('woff2'),
        url('https://${CDN_HOST}/media/fonts/styrene-ui/styrene-ui_medium.woff') format('woff');
    font-weight: 500;
    font-style: normal;
}
@font-face {
    font-family: 'Styrene UI';
    src: url('https://${CDN_HOST}/media/fonts/styrene-ui/styrene-ui_bold.woff2') format('woff2'),
        url('https://${CDN_HOST}/media/fonts/styrene-ui/styrene-ui_bold.woff') format('woff');
    font-weight: 700;
    font-style: normal;
}`}
/>
...
<Source
    ...
    src: url('https://${CDN_HOST}/media/fonts/alfa-interface-sans_regular.woff2') format('woff2');
    font-weight: 400;
    font-style: normal;
}
@font-face {
    font-family: 'Alfa Interface Sans';
    src: url('https://${CDN_HOST}/media/fonts/alfa-interface-sans_medium.woff2') format('woff2');
    font-weight: 500;
    font-style: normal;
}
@font-face {
    font-family: 'Alfa Interface Sans';
    src: url('https://${CDN_HOST}/media/fonts/alfa-interface-sans_bold.woff2') format('woff2');
    font-weight: 700;
    font-style: normal;
}`}
/>
