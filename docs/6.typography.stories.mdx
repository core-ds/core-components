...
<Meta
    title='Guidelines/Дизайн-токены и ассеты/Типографика'
...
-   Компоненты [Typography.Title](/docs/components-typography--typography-title),
    [Typography.TitleResponsive](/docs/components-typography--typography-title-responsive) и 
    [Typography.Text](/docs/components-typography--typography-text)
